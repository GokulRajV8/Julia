...
public class Core extends Thread{
	...
	public Core() {
		...
		this.thread = new JuliaThread[29];
		...
		this.thread[0].isJulia = isJulia; this.thread[1].isJulia = isJulia; this.thread[2].isJulia = isJulia; this.thread[3].isJulia = isJulia;
		for(int i = 0; i < 8000; i = i + 1600) {
			for(int j = 0; j < 8000; j = j + 1600) {
				...
				thread[5 * i/1600 + j/1600 + 4].isJulia = isJulia;
			}
		}
	}
